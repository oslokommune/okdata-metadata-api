...
MIN_EDITION_AGE_DAYS = 30
NUM_EDITIONS_TO_KEEP = 3
...
def _prunable_editions(editions):
    ...
    "Prunable" being more than 30 days old, and past the third generation of
    editions.
    """
    return filter(
        _old_enough_to_delete,
        sorted(editions, key=_edition_timestamp, reverse=True)[NUM_EDITIONS_TO_KEEP:],
    )
