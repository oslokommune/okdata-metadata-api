...
class EditionTest(unittest.TestCase):
    ...
    def test_post_edition(self):
        ...
        _, _, response = common_test_helper.post_edition(common_test_helper.dataset_event,
    ...
    def test_update_edition(self):
        ...
        response_from_dataset_post, response_from_version_post, response_from_edition_post = common_test_helper.post_edition(
            common_test_helper.dataset_event, common_test_helper.version_event, common_test_helper.edition_event)
        ...
        edition_event_for_put["pathParameters"] = {
            ...
            "edition-id": common_test_helper.read_result_body(response_from_edition_post)
        }
