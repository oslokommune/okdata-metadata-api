...
class VersionTest(unittest.TestCase):
    ...
    def test_post_version(self):
        ...
        _, version_response = common_test_helper.post_version(common_test_helper.dataset_event,
    ...
    def test_update_version(self):
        ...
        event_for_version_put["pathParameters"] = {
            "dataset-id": common_test_helper.read_result_body(response_from_dataset_post),
            "version-id": common_test_helper.read_result_body(response_from_version_post)
        }
    ...
    def test_get_all_versions(self):
        ...
        response_from_dataset_post, _ = common_test_helper.post_version(common_test_helper.dataset_event,
                                                                        common_test_helper.version_event,
    ...
    def test_get_one_version(self):
        ...
        path_parameter_for_get_event = {
            "pathParameters": {
                "dataset-id": common_test_helper.read_result_body(response_from_dataset_post),
                "version-id": common_test_helper.read_result_body(response_from_post_as_json)
            }}
        ...
        assert response_from_get_as_json[0][table.VERSION_ID] == common_test_helper.read_result_body(
